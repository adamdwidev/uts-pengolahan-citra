...
def main():
    ...
    if uploaded_file is not None:
        ...
        with col2:
            ...
            selected_option = st.sidebar.selectbox("Select an option", ["RGB to HSV", "Histogram", "Brightness and Contrast", "Contour", "Grayscale", "Blur", "Edge Detection", "Thresholding", "Rotate", "Resize", "Flip", "Crop"],index=0)
